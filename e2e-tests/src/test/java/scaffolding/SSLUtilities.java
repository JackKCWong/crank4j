...
public final class SSLUtilities {
    ...
    public static CertificatesChecker testCertificationChecker = CertificatesChecker.getCertificatesChecker(dirPath(FileFinder.testFile("keystore.jks")), "password");
